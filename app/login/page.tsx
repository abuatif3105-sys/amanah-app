...
export default function UnitManagement() {
  ...
  // Kategori Pengeluaran Baru khusus Kuttab
  ...
  // Daftar Kategori Kas Keluar Kuttab Terbaru
  ...
  const handleKasKeluar = async (e: React.FormEvent) => {
    ...
    if (slug === 'kuttab') {
      finalProgram = kuttabCategory; // Langsung menggunakan kategori pilihan baru
    } else if (slug === 'wakpro') {
